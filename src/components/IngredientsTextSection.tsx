      ...
      <div className="text-content">
        ...
        <div style={{ marginBottom: "2rem" }}>
          ...
          <IngrediensSection title="Ingredients">
            ...
            Limonene, Coumarin, Citral, Geraniol, Citronellol, Eugenol.
          </IngrediensSection>

          <IngrediensSection title="Shipping & Returns">
            Free shipping on all orders over $75. Returns accepted within 30
            days of purchase. Perfumes must be unopened and in original
            packaging.
          </IngrediensSection>
        </div>
      </div>
